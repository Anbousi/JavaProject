                                    ...
                                    <div class="card-footer">
                                        <c:choose>
                                            ...
                                            <c:when test="${painting.getCart() == null}">
                                                <small class="text-muted"><a class=" btn btn-primary btn-sm"
                                                        href="/category/${painting.getCategory().getId()}/painting/${painting.id}">More
                                                        Details...</a></small>
                                            </c:when>

                                            <c:otherwise>
                                                <small class="text-muted"><a class=" btn btn-secondary btn-sm"
                                                        href="/category/${painting.getCategory().getId()}/painting/${painting.id}">Sold
                                                        Out!</a></small>
                                            </c:otherwise>
                                        </c:choose>

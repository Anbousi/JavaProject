														...
														<div class="clearfix" style="width: 135%;">
															<div id="thumbcarousel" class="carousel slide"
																...
																<div class="carousel-inner">
																	<div class="item active">
																		<c:forEach items="${paintings}" var="painting">
																			<a
																				href="/category/${painting.getCategory().getId()}/painting/${painting.id}">
																...
																<a class="left carousel-control" href="#thumbcarousel"
																	...
																	href="#thumbcarousel" role="button"
									...
									<div class="widget-area">
										<aside class="widget">
											...
											<form class="wpcf7" method="post"
												action="/send/email/${painting.id}/${painting.getCategory().getId()}"
												id="contactform">
												<div class="form">
														...
														<div class="col">
															...
															<c:choose>
																...
																<c:when test="${painting.getCart() == null}">
																	<a
																		href="/cart/add_cart/${category.id}/${painting.id}"><button
																			class="btn btn-primary">Add to
																			cart</button></a>
																</c:when>

																<c:otherwise>
																	<button class="btn btn-primary" disabled>Sold
																		out</button>
																</c:otherwise>
															</c:choose>

	...
	<div id="page">
		<div class="container">
			...
			<div id="content" class="site-content">
				<div id="primary"
					class="content-area column two-thirds single-portfolio">
					<main id="main" class="site-main minhight">

						<article class="portfolio hentry">
							<header class="entry-header">
								<div class="entry-thumbnail">
									<img src="/painting-photos/${painting.id}/${painting.pic}"
										class="category_top">
								</div>
								<h1 class="entry-title">
									Artist Name :
									<c:out value="${painting.artistname}" />
								</h1>
							...
							<div class="container">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="clearfix" style="width: 135%;">
												...
												<div class="carousel-inner">
													<div class="item active">
														<c:forEach items="${paintings}" var="painting">
															<a
																href="/category/${painting.getCategory().getId()}/painting/${painting.id}"><div
																	data-target="#carousel" class="thumb">
																	<img
																		src="/painting-photos/${painting.id}/${painting.pic}"
																		class="category">
																</div></a>
														</c:forEach>
													</div>
				...
				<div id="secondary" class="column third">
					<div class="widget-area">
						<aside class="widget">
							...
							<form class="wpcf7" method="post" action="/send/email/${painting.id}/${painting.getCategory().getId()}"
								id="contactform">
								<div class="form">
									...
									<input type="submit" id="submit" class="clearfix btn"
										value="Send">
								</div>
									...
									<div class="row">
										<div class="col">
											<div class="form-group mb-2">
												...
												<input class="form-control qty" id="quantity"
										...
										<div class="col">
											...
											<c:choose>
												...
												<c:when test="${painting.getCart() == null}">
													<a href="/cart/add_cart/${category.id}/${painting.id}"><button
											...
											<br> <br> <a href="/cart">View Chart </a>
										</div>
	...
	<script type="text/javascript">
		(function(i, s, o, g, r, a, m) {
			...
			m.parentNode.insertBefore(a, m)
				...
				'https://salescloud.is/js/salescloud.js', 'salescloud');
	</script>

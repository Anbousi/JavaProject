				...
				<div class="container">
					<header id="masthead" class="site-header">
						<div class="site-branding">
							<h1 class="site-title"><a href="index.html" rel="home">Artisto</a></h1>
								...
								<article class="portfolio hentry">
									<header class="entry-header">
										<div class="entry-thumbnail">
											<img width="800" height="533" src="../img/wall.jpg"
									...
									<div class="entry-content">
										...
										<p>
											...
											indeed, in the leafless shrubbery an hour in the morning.
										</p>
										<blockquote>
											<p>
    ...
    width: 135%;">
								...
								<aside class="widget">
									...
									<form class="wpcf7" method="post" action="#" id="contactform">
										...
										<div> <br> <br> <br>
											...
											<p>Some text about the jeans. Super slim and comfy lorem ipsum lorem
												jeansum. Lorem jeamsun denim lorem jeansum.</p>
												...
												<div class="row">
													<div class="col">
														<div class="form-group mb-2">
															...
															<select class="form-control qty" id="quantity"
																name="quantity">
													...
													<div class="col">
														<button type="button" class="btn btn-primary salescloud-action"
															data-action-triggers="click" data-action-method="jsonp"
													...
													data-action-on-processed='[{"type": "prependHTML", "target":
													".container-fluid", "html": "<div class=\"alert alert-success\"
														role=\"alert\">Product has been added to cart!</div>"}]'
													data-loading-text="Processing...">Add to cart</button>
												</div>
											</div>
										</div>
			...
			<script type="text/javascript">
				(function (i, s, o, g, r, a, m) {
					i['SalesCloudObject'] = r; i[r] = i[r] || function () {
